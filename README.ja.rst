...
::
  ...
  "hello world"
  $ seq 5 | owk -i line '{ put : _.1 * 2 }'
  2
  4
  6
  8
  10
  $ echo '{"name":"roi"}{"name":"zak"}' | owk '{ put : _.name }'
  "roi"
  "zak"
...
::
  $ echo '{ "value": 1 } { "value": 2 } { "value": 3 }' | owk -i json '{ put _.value }'
  1
  2
  3
...
::
  ...
  $ echo '1 2 three' | owk -i line '{ put _ }'
...
::
  ...
  $ owk -o ltsv -e 'put { key => "value", key2 => 100 }'
  key:value	key2:100
